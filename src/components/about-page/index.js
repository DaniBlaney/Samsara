    ...
    <>
      ...
      <Container fluid>
        <Row className="justify-content-md-center">
          <Col>
            <Card.Img className="" src="./images/jen.png" />
          </Col>
          <Col>
            <h1>About the Doctor</h1>

            <p>Dr. Jennifer Redmond's interest in the world of Wellness began with a
              ...
              career, while completing two degrees at Raritan Valley Community College.</p>
          </Col>
        </Row>
        <Row>
          <Col>
            <p>
                She received her Bachelor of Arts from Excelsior College in Albany, New York and
                ...
                program. During her internship she pursued and completed a post-doctorate
            ...
            <p>In her spare time, Dr. Redmond continues to attend seminars to improve herself and her skills for
              ...
              where she volunteers as a Youth Advisor. She's always looking for new ways to serve her community and her patients.</p>
          </Col>
        </Row>
      </Container>
      <FooterComponent />
